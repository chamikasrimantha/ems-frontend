...
export default function SuperAdminSalaries() {
    ...
    const gotoCreate = () => {
        navigate('/superadmin/create-salary');
    };

    const gotoSummary = () => {
        navigate('/superadmin/salaries/summary');
    }
    ...
    const gotoAllowances = () => {
        navigate("/superadmin/salaries/allowances");
    }

    const gotoTransfers = () => {
        navigate("/superadmin/salaries/transfers");
    }
